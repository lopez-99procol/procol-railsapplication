Rails.application.routes.draw do
  ...
  post 'users/profile/',                  to: 'users#profile',          as: 'userprofile'
  get 'users/profile/edit/:id',           to: 'users#profile_load',     as: 'loaduserprofile'
  post 'users/profile/edit/:id',          to: 'users#profile_save',     as: 'saveuserprofile'
